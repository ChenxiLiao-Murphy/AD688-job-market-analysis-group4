...
![](figureswxw/urban_rural_ai_nonai_bar.png){width=80% fig-align='center' fig-cap="Urban and Rural Regions: AI vs Non-AI Job Postings (Stacked Bar Chart)"}
...
if not missing_columns:
    ...
    # Urban 
    data_urban = pivot_urban.loc["Urban"]
    axes[0].pie(
        data_urban,
        labels=data_urban.index,
        autopct='%1.1f%%',
        startangle=90,
        colors=["#ff9999", "#66b3ff"],
        wedgeprops={'edgecolor': 'black'}
    )
    axes[0].set_title("Urban - AI vs Non-AI")

    # Rural 
    data_rural = pivot_urban.loc["Rural"]
    axes[1].pie(
        data_rural,
        labels=data_rural.index,
        autopct='%1.1f%%',
        startangle=90,
        colors=["#ff9999", "#66b3ff"],
        wedgeprops={'edgecolor': 'black'}
    )
    axes[1].set_title("Rural - AI vs Non-AI")
 ...
 ![](figureswxw/urban_rural_ai_nonai_pie_combined.png){width=80% fig-align='center' fig-cap="Urban and Rural Regions: AI vs Non-AI Job Postings"}
