...
**What role does PCA plays here?**
PCA can simplify your complex data into just 2 main features - while retaining as much of the variation in the data as possible. In this situation, the complex KMeans algorithm can be simplified into a two-dimensional graph, mainly focusing on the structure and differences among the career categories.
